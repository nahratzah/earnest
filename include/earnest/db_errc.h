#ifndef EARNEST_DB_ERRC_H
#define EARNEST_DB_ERRC_H
...
earnest_export_ auto make_error_code(db_errc e) -> std::error_code;
earnest_export_ auto db_error_category() -> const std::error_category&;


} /* namespace earnest */

namespace std {
template<> struct is_error_code_enum<earnest::db_errc> : true_type {};
} /* namespace std */


#endif /* EARNEST_DB_ERRC_H */
