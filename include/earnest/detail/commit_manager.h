#ifndef EARNEST_DETAIL_COMMIT_MANAGER_H
#define EARNEST_DETAIL_COMMIT_MANAGER_H
 ...
 */
class earnest_export_ commit_manager {
  public:
  ...
  public:
  class earnest_export_ commit_id {
  ...
  class earnest_export_ write_id_state_ {
    protected:
  ...
  static auto allocate(const txfile& f, fd::offset_type off, allocator_type alloc = allocator_type()) -> std::shared_ptr<commit_manager>;
...
class earnest_export_ commit_manager::write_id {
  friend commit_manager;
...
#endif /* EARNEST_DETAIL_COMMIT_MANAGER_H */
