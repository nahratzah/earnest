#ifndef EARNEST_DETAIL_COMMIT_MANAGER_IMPL_H
#define EARNEST_DETAIL_COMMIT_MANAGER_IMPL_H
...
class earnest_export_ commit_manager_impl
  ...
  public std::enable_shared_from_this<commit_manager_impl>
{
  ...
  class earnest_local_ state_impl_ final
  : public state_,
  ...
  class earnest_local_ write_id_state_impl_ final
  ...
  private:
  commit_manager_impl(fd::offset_type off, allocator_type alloc);
  ...
  static auto allocate(const txfile& f, fd::offset_type off, allocator_type alloc = allocator_type()) -> std::shared_ptr<commit_manager_impl>;
  ...
  static void init(txfile::transaction& tx, fd::offset_type off);
...
#endif /* EARNEST_DETAIL_COMMIT_MANAGER_IMPL_H */
