#ifndef EARNEST_DETAIL_TX_SEQUENCER_H
#define EARNEST_DETAIL_TX_SEQUENCER_H
 ...
 */
class earnest_export_ tx_sequencer
...
#endif /* EARNEST_DETAIL_TX_SEQUENCER_H */
